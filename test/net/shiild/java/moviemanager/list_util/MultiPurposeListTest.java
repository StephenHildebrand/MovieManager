...
public class MultiPurposeListTest {
	...
	Movie movie1, movie2, movie3, movie4, movie5, movie6, movie7, movie8, movieNull;
	/** Declare the movies MultiPurposeList */
	MultiPurposeList<Movie> movieList, nullList;
	...
	public void setUp() throws Exception {
		// Instantiate a list for Movie objects
		movieList = new MultiPurposeList<Movie>();
		...
		movie6 = new Movie("2 Selma");
		movie7 = new Movie("2 Big Hero 6");
		movie8 = new Movie("2 Maleficent");
	...
	public void testIsEmpty() {
		...
		nullList = new MultiPurposeList<Movie>();
