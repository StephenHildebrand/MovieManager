...
public class Movie {
     ...
     */
    public Movie(String rawLine) throws IllegalArgumentException {
     ...
     * <p>
     * If the argument Movie name is lexically equivalent to this movie name,
     * zero is returned.
     * <p>
     * A negative number is returned if this Movie name is lexically less than
     * the argument Movie (meaning this Movie belongs prior to the argument
     * movie).
     * <p>
     ...
     * if this Movie is before, positive if the movie is after
     */
    public int compareToByName(Movie otherMovie) {
